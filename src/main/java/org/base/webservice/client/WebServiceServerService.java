 ...
 * 
 */
@WebServiceClient(name = "WebServiceServerService", targetNamespace = "http://server.webservice.base.org/", wsdlLocation = "http://localhost:9001/service/serviceHello?wsdl")
    ...
    extends Service
{
    ...
    private final static QName WEBSERVICESERVERSERVICE_QNAME = new QName("http://server.webservice.base.org/", "WebServiceServerService");
    ...
    public WebServiceServer getWebServiceServerPort() {
        return super.getPort(new QName("http://server.webservice.base.org/", "WebServiceServerPort"), WebServiceServer.class);
    }
    ...
    public WebServiceServer getWebServiceServerPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://server.webservice.base.org/", "WebServiceServerPort"), WebServiceServer.class, features);
    }
