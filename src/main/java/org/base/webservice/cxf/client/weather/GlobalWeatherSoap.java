...
public interface GlobalWeatherSoap {
    ...
    @RequestWrapper(localName = "GetWeather", targetNamespace = "http://www.webserviceX.NET", className = "org.base.webservice.cxf.client.weather.GetWeather")
    @ResponseWrapper(localName = "GetWeatherResponse", targetNamespace = "http://www.webserviceX.NET", className = "org.base.webservice.cxf.client.weather.GetWeatherResponse")
    ...
    @RequestWrapper(localName = "GetCitiesByCountry", targetNamespace = "http://www.webserviceX.NET", className = "org.base.webservice.cxf.client.weather.GetCitiesByCountry")
    @ResponseWrapper(localName = "GetCitiesByCountryResponse", targetNamespace = "http://www.webserviceX.NET", className = "org.base.webservice.cxf.client.weather.GetCitiesByCountryResponse")
